...
export class StudentAttendanceController {
  ...
  getMyChildrenAttendance = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    if (!req.user) {
    ...
    const data = await this.service.findAllForParent(req.user.id, query);
    respond(res, data);
  });

  create = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    const data = await this.service.create(req.body as CreateStudentAttendanceDto);
    respond(res, data, 201);
  });

  bulkUpsert = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    const data = await this.service.bulkUpsert(req.body as BulkUpsertStudentAttendanceDto);
    respond(res, data, 201);
  });
...
export class TeacherAttendanceController {
  ...
  getMyChildrenTeachersAttendance = asyncHandler(
  ...
  create = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    const data = await this.service.create(req.body as CreateTeacherAttendanceDto);
    respond(res, data, 201);
  });

  bulkUpsert = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    const data = await this.service.bulkUpsert(req.body as BulkUpsertTeacherAttendanceDto);
    respond(res, data, 201);
  });
