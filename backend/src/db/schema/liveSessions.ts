import { pgTable, uuid, varchar, uniqueIndex, timestamp, index, check } from 'drizzle-orm/pg-core';
...
export const liveSessions = pgTable(
  ...
  (table) => ({
    ...
    idx_live_sessions_conversation: index('idx_live_sessions_conversation').on(
