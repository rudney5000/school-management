...
- [ ] Offline : mutations critiques passent par la sync queue — ⚠️ `features/offline-sync` et `useOfflineQueue` n'existent pas encore (voir `docs/BILAN.md`) ; tant que ce n'est pas construit, ignorer ce point ou le faire remonter comme prérequis
