...
> ⚠️ Pas encore implémenté dans le projet (ni la dépendance `@tanstack/react-query-persist-client`, ni `idb-persister`). Pattern cible à construire, pas un état actuel — voir `docs/BILAN.md`.
