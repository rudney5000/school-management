        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.section}>
                    <Text style={styles.sectionTitle}>{t.studentInformation ?? "Informations de l'élève"}</Text>
                    <View style={styles.grid}>
                        ...
                        <View style={styles.field}>
                            ...
                            <Text style={styles.value}>{age} {t.years ?? 'ans'}</Text>
                        </View>
                        {parentFullName && (
                            <View style={styles.field}>
                ...
                <View style={styles.section}>
                    <Text style={styles.sectionTitle}>{t.enrollmentInformation ?? "Informations d'inscription"}</Text>
                    <View style={styles.grid}>
                        <View style={styles.field}>
