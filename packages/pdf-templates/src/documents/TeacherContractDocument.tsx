...
export function TeacherContractDocument({
    ...
    const formattedEndDate = contractEndDate ? new Date(contractEndDate).toLocaleDateString(locale) : null;
    const genderLabel = gender === 'male' ? t.male : t.female;

    const maritalStatusLabel = maritalStatus
        ? { single: t.single, married: t.married, divorced: t.divorced, widowed: t.widowed }[maritalStatus]
        : '—';

    const contractTypeLabel = { permanent: t.permanent, fixed_term: t.fixedTerm, part_time: t.partTime }[contractType];
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.grid}>
                        ...
                        <View style={styles.field}>
                            ...
                            <Text style={styles.value}>{age} {t.years}</Text>
                        </View>
                        <View style={styles.field}>
                        ...
                        <View style={styles.field}>
                            ...
                            <Text style={styles.value}>
                                {hasChildren ? `${t.yes} (${childrenCount})` : t.no}
                            </Text>
                        </View>
                        <View style={styles.field}>
                            <Text style={styles.label}>{t.yearsOfExperience}</Text>
                            <Text style={styles.value}>{yearsOfExperience} {t.years}</Text>
                        </View>
                        {qualification && (
                            <View style={styles.field}>
                    ...
                    <View style={styles.grid}>
                        ...
                        {weeklyHours !== null && (
                            <View style={styles.field}>
                                ...
                                <Text style={styles.value}>{weeklyHours} {t.hoursPerWeek}</Text>
                            </View>
                        )}
                        {subjectsTaught && (
                            <View style={styles.field}>
