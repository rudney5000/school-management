...
workspace "School Management Architecture" "C4 architecture for the multi-school SaaS platform." {
    model {
        ...
        schoolManagement = softwareSystem "School Management" "Multi-tenant, offline-first school management platform." {
            ...
            auth = component "Authentication and authorization" "JWT authentication, password and SMS OTP login, roles and tenant access control." "TypeScript"
            ...
            communication = component "Communication" "Chat, events, notifications (SMS via android-sms-gateway) and video call coordination." "TypeScript"
        ...
        api -> redis "Caches data, coordinates sockets and dispatches SMS via Streams" "Redis protocol"
        ...
        api -> smsGateway "Sends SMS notifications and OTP codes" "HTTPS API"
