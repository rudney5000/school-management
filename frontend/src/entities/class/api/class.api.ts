...
import type { ClassParamsDto, ClassListQueryDto } from '@entities/class/model/dto';
import type { CreateClassDto, Class, UpdateClassDto } from '@entities/class';
...
export class ClassApi extends ApiWrapper {
  ...
  delete(id: string, subSchoolId: string) {
    return this.handleRequest(this._baseApi.delete(`/classes/${id}`, { subSchoolId }), undefined);
  }
}
