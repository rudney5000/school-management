...
import type { CreateParentDto, Parent, UpdateParentDto } from '@entities/parent';
...
export class ParentApi extends ApiWrapper {
  ...
  delete(id: string, subSchoolId: string) {
    return this.handleRequest(this._baseApi.delete(`/parents/${id}`, { subSchoolId }), undefined);
  }
}
