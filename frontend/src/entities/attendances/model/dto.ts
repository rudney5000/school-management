...
export type UpdateStudentAttendanceDto = Partial<
  Pick<CreateStudentAttendanceDto, 'status' | 'reason' | 'note'>
>;
...
export type UpdateTeacherAttendanceDto = Partial<
  Pick<CreateTeacherAttendanceDto, 'status' | 'reason'>
>;
