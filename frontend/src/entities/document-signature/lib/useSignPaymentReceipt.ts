...
import type { PaymentReceiptSignDto } from '@entities/document-signature/model/createDocumentSignatureSchema';
  ...
  return useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({
        queryKey: ['document-signature', 'payment-receipt', 'status'],
      });
    },
    onError: (error: Error) => {
