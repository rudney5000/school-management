...
import type { CourseParamsDto, CourseListQueryDto } from '@entities/courses/model/dto';
import type { CreateCourseDto, Course, UpdateCourseDto } from '@entities/courses';
...
export class CourseApi extends ApiWrapper {
  ...
  delete(id: string, subSchoolId: string) {
    return this.handleRequest(this._baseApi.delete(`/courses/${id}`, { subSchoolId }), undefined);
  }
}
