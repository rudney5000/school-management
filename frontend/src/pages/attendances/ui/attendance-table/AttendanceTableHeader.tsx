  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 px-4 sm:px-5 py-3 border-b border-border">
      ...
      <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
        <Tabs
          value={activeTab}
          onValueChange={(v) => onTabChange(v as 'students' | 'teachers' | 'staff')}
        >
          <TabsList className="h-8 bg-muted p-0.5">
            <TabsTrigger
              ...
              style={
                activeTab === 'students' ? { background: '#f472b6', color: 'white' } : undefined
              }
            >
            ...
            <TabsTrigger
              ...
              style={
                activeTab === 'teachers' ? { background: '#1755EC', color: 'white' } : undefined
              }
            >
