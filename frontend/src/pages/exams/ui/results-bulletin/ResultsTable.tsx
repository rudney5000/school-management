...
import type { SortBy } from '@/pages/exams/ui/results-bulletin/model/useResultsBulletin';
import { SignatureBadge, type SignatureStatusResult } from '@entities/document-signature';
          ...
          <Select value={sortBy} onValueChange={(value: SortBy) => onSortChange(value)}>
            ...
            <SelectContent>
              <SelectItem value="weighted">
                {t('dashboard.exams.results.weightedAverage')}
              </SelectItem>
                ...
                <TableRow key={result.studentId}>
                  ...
                  <TableCell className="text-center">
                    <div className="flex flex-col items-center gap-1">
                      {status ? (
                        <SignatureBadge status={status} labels={signatureBadgeLabels} />
                      ) : (
                      ...
                      {canSign && (!isSigned || isStale) && (
                        <Button
                          ...
                          title={
                            isStale
                              ? t('dashboard.exams.results.reSign')
                              : t('dashboard.exams.results.sign')
                          }
                        >
