...
import { Card, CardHeader, CardDescription, CardTitle } from '@/shared/ui';
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <Card>
        <CardHeader className="pb-2">
          <CardDescription className="text-xs">
            {t('dashboard.exams.results.classAverage')}
          </CardDescription>
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardDescription className="text-xs">
            {t('dashboard.exams.results.bestAverage')}
          </CardDescription>
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardDescription className="text-xs">
            {t('dashboard.exams.results.passRate')}
          </CardDescription>
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardDescription className="text-xs">
            {t('dashboard.exams.results.students')}
          </CardDescription>
