...
import { Button, Spinner, Tabs, TabsContent } from '@shared/ui';
import { ChildResults } from '@/pages/exams/ui/ChildResults';
import { ChildrenExamsTable } from '@/pages/exams/ui/ChildrenExamsTable';
...
export function ChildrenReportCard() {
  ...
  const tabs = [
    ...
    {
      value: 'upcoming',
      label: t('dashboard.exams.reportCard.tabs.upcoming'),
      icon: CalendarClock,
    },
  ];
