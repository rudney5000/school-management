...
import { cn, getInitials, useTranslation } from '@shared/lib';
import { useExamResultsByStudent } from '@entities/exams';
import { Spinner, Avatar, AvatarFallback, AvatarImage } from '@/shared/ui';
    ...
    <div className="rounded-2xl bg-white border border-zinc-100/80 shadow-sm p-4">
      <div className="flex items-center justify-between mb-3.5">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-sm font-semibold text-zinc-900">{fullName}</h3>
            ...
            >
              <div className="min-w-0">
                ...
                <p className="text-xs text-zinc-500 mt-0.5">
                  {new Date(r.examDate).toLocaleDateString('fr-FR')} ·{' '}
                  {t(`dashboard.exams.types.${r.examType}`)}
                </p>
              </div>
              {r.score !== null ? (
                <span
