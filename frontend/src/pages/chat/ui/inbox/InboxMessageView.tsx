...
import { Avatar, AvatarFallback, Button, ScrollArea, Separator } from '@shared/ui';
...
export function InboxMessageView({
  ...
  return (
    <div className="flex flex-1 flex-col overflow-hidden">
          ...
          <div className="text-sm text-foreground leading-relaxed whitespace-pre-wrap">
            {message.isDeleted ? (
              <span className="italic text-muted-foreground">
                {t('dashboard.chat.messageDeleted')}
              </span>
            ) : (
              message.content
            )}
      ...
      {replyOpen && !readOnly && (
        <InboxReplyComposer message={message} conversation={conversation} onClose={onReplyClose} />
      )}
