import { Inbox, Star, Send, FileText, AlertCircle, Trash2, Plus, Megaphone } from 'lucide-react';
...
export function ChatSidebar({ selectedCategory, onSelectCategory, counts }: ChatSidebarProps) {
  ...
  const labels = [
    ...
    {
      id: 'administration',
      label: t('dashboard.chat.labels.administration'),
      color: 'bg-slate-400',
      count: 2,
    },
  ];
  ...
  const categories = [
    ...
    {
      id: 'announcements',
      label: t('dashboard.chat.categories.announcements'),
      icon: Megaphone,
      count: counts.announcements,
    },
    {
      id: 'starred',
      label: t('dashboard.chat.categories.starred'),
      icon: Star,
      count: counts.starred,
    },
    {
      id: 'unread',
      label: t('dashboard.chat.categories.unread'),
      icon: Send,
      count: counts.unread,
    },
    {
      id: 'groups',
      label: t('dashboard.chat.categories.groups'),
      icon: FileText,
      count: counts.groups,
    },
    {
      id: 'direct',
      label: t('dashboard.chat.categories.direct'),
      icon: AlertCircle,
      count: counts.direct,
    },
    {
      id: 'archived',
      label: t('dashboard.chat.categories.archived'),
      icon: Trash2,
