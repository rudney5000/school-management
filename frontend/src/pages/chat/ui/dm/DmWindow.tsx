...
import { Reply, MoreHorizontal, Video } from 'lucide-react';
import { Button } from '@shared/ui';
import { MessageList } from '../MessageList';
import { MessageInput } from '../MessageInput';
import type { Conversation, Message, UploadedFile } from '@entities/chat';
import { getConversationDisplayName } from '@entities/chat/lib/getConversationDisplayName';
import { callUiSlice, useCreateVideoCallSession } from '@entities/video-call';
...
export function DmWindow({
  ...
  const { mutate: createVideoCall, isPending: isCreatingCall } =
    useCreateVideoCallSession(subSchoolId);
