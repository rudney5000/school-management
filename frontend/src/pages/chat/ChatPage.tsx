  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-background">
      ...
      <div className="flex flex-1 overflow-hidden relative">
        <div
          className={`${isSidebarOpen ? 'flex' : 'hidden'} lg:flex flex-col border-r border-zinc-200 bg-white absolute lg:relative z-10 lg:z-0 h-full w-64 lg:w-auto`}
        >
          <ChatSidebar
        ...
        <div
          className={`${showConversationList || !activeConversation ? 'flex' : 'hidden'} lg:flex flex-col w-full lg:w-80 border-r border-zinc-200 bg-white`}
        >
          <ConversationList
