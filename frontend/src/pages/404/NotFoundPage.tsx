              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 text-left">
                  <h3 className="font-semibold text-slate-950">
                    {t('notFound.looking_for_something')}
                  </h3>
                  <p className="mt-1 text-sm text-slate-600">{t('notFound.use_navigation')}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <Card className="relative overflow-hidden rounded-[2rem] border-0 bg-blue-600 p-8 text-white shadow-[0_30px_80px_rgba(37,99,235,0.35)]">
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <h2 className="text-2xl font-semibold">{t('notFound.page_on_trip')}</h2>
                  <p className="mt-3 text-white/80">{t('notFound.dont_worry')}</p>
                </div>

                <div className="grid gap-4">
                  <div className="rounded-2xl bg-white/10 p-4 backdrop-blur-sm">
                    <h3 className="font-semibold">{t('notFound.school_management')}</h3>
                    <p className="mt-1 text-sm text-white/80">{t('notFound.complete_platform')}</p>
                  </div>
                  <div className="rounded-2xl bg-white/10 p-4 backdrop-blur-sm">
                    <h3 className="font-semibold">{t('notFound.establishments')}</h3>
                    <p className="mt-1 text-sm text-white/80">{t('notFound.join_community')}</p>
                  </div>
                  <div className="rounded-2xl bg-white/10 p-4 backdrop-blur-sm">
                    <h3 className="font-semibold">{t('notFound.multi_users')}</h3>
                    <p className="mt-1 text-sm text-white/80">{t('notFound.users_list')}</p>
                  </div>
                </div>
              </div>
            </Card>
