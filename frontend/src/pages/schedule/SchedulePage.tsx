...
import { type ScheduleWithRelations, useSchedulesList } from '@entities/schedule';
import {
  AddScheduleForm,
  EditScheduleForm,
  DeleteScheduleAlert,
...
const SchedulePage = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen bg-zinc-50">
      ...
      <div
        className={`${isSidebarOpen ? 'flex' : 'hidden'} lg:flex w-full lg:w-[280px] bg-white border-r border-zinc-200 flex-col lg:h-full h-auto max-h-[50vh] lg:max-h-none overflow-y-auto`}
      >
        <ScheduleList
