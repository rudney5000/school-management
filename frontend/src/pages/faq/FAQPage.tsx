      ...
      <section className="mx-auto max-w-7xl px-6 py-8 lg:px-10 lg:py-12">
        ...
        <div className="mb-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {quickLinks.map((link) => (
            <Card
              key={link.title}
              className="group cursor-pointer rounded-3xl border-0 bg-white p-5 shadow-sm transition-all hover:shadow-lg"
            >
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          <div className="lg:col-span-1">
            <Card className="sticky top-8 rounded-[2rem] border-0 bg-blue-600 p-6 text-white shadow-[0_20px_60px_rgba(37,99,235,0.25)]">
              ...
              <p className="mt-3 text-sm text-white/80">{t('faq.support.description')}</p>
              ...
              <Button
                asChild
                className="mt-6 w-full rounded-full bg-white px-6 text-blue-600 hover:bg-white/90"
              >
          ...
          <div className="lg:col-span-2">
            <div className="space-y-6">
              {faqCategories.map((category) => (
                <Card
                  key={category.title}
                  className="rounded-[2rem] border-0 bg-white p-6 shadow-sm"
                >
                  <div className="mb-6 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">
                        {t('faq.questionsCount', { count: category.questions.length })}
                      </p>
                    </div>
                  </div>
