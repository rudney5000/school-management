    ...
    const fetchSchedule = async () => {
      try {
        ...
        const items: ScheduleItem[] = todaySchedules.map((s, index) => {
          ...
          const courseName =
            courseNameById.get(s.courseId) ?? t('dashboard.widgets.scheduleWidget.course');
          const className =
            classNameById.get(s.classId) ?? t('dashboard.widgets.scheduleWidget.class');
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-zinc-400 mt-0.5">
                {t('dashboard.widgets.scheduleWidget.loading')}
              </p>
            </div>
          </div>
        </CardHeader>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-zinc-400 mt-0.5">
              ...
              · {t('dashboard.widgets.scheduleWidget.periods', { count: schedule.length })}
            </p>
          </div>
          ...
          schedule.map((item) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs text-zinc-400 truncate">{item.room}</div>
              </div>
