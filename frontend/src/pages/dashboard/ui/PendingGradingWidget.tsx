        ...
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <CardTitle className="text-base">
              {t('dashboard.widgets.pendingGrading.title')}
            </CardTitle>
            <span className="text-xs bg-red-100 text-red-600 font-semibold px-2 py-0.5 rounded-full">
              {t('dashboard.widgets.pendingGrading.loading')}
            </span>
          </div>
          <p className="text-xs text-zinc-400">
            {t('dashboard.widgets.pendingGrading.submissionsAwaitingReview')}
          </p>
        </CardHeader>
        <CardContent>
    ...
    <Card>
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs bg-red-100 text-red-600 font-semibold px-2 py-0.5 rounded-full">
            {pendingGrading.length} {t('dashboard.widgets.pendingGrading.pending')}
          </span>
        </div>
        <p className="text-xs text-zinc-400">
          {t('dashboard.widgets.pendingGrading.gradesAwaitingScore')}
        </p>
      </CardHeader>
