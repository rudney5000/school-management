          ...
          const upcoming: UpcomingEventItem[] = response.result
            ...
            .map((e: SchoolEvent) => {
              ...
              return {
                ...
                date: overdue
                  ? t('dashboard.widgets.upcomingEvents.past')
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-zinc-400 mt-0.5">
                {t('dashboard.widgets.upcomingEvents.loading')}
              </p>
            </div>
          </div>
        </CardHeader>
          ...
          events.map((event) => (
            <div key={event.id} className="flex items-center gap-3 group cursor-pointer">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs text-zinc-400 truncate">{event.sub}</div>
              </div>
              ...
              <div className="text-right shrink-0">
                <div
                  className={cn(
                    ...
                    event.overdue ? 'text-red-500' : 'text-zinc-600',
                  )}
                >
                  {event.date}
                </div>
