...
export const EditScheduleForm: React.FC<Props> = ({
  schedule,
  isOpen,
  handleOpen,
  handleSuccess,
  ...
  const form = useForm<UpdateScheduleDto>({
  ...
  function onSubmit(dto: UpdateScheduleDto) {
    mutate(
      {
        id: schedule.id,
        dto,
  ...
  return (
    <CustomDrawer
      ...
      drawerTitle={t('dashboard.schedules.form.editTitle')}
      drawerDescription={t('dashboard.schedules.form.editDescription')}
    >
      <Form {...form}>
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="WEDNESDAY">
                      {t('dashboard.schedules.days.wednesday')}
                    </SelectItem>
                    <SelectItem value="THURSDAY">
                      {t('dashboard.schedules.days.thursday')}
                    </SelectItem>
                    <SelectItem value="FRIDAY">{t('dashboard.schedules.days.friday')}</SelectItem>
                    <SelectItem value="SATURDAY">
                      {t('dashboard.schedules.days.saturday')}
                    </SelectItem>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                  ...
                  <div className="space-y-1 leading-none">
                    <FormLabel className="cursor-pointer">Séance en ligne (avec live)</FormLabel>
                  </div>
                </FormItem>
              )}
            />
