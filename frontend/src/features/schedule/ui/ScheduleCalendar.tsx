...
const DAY_BG_COLORS = ['bg-[#E8F5F0]', 'bg-[#EDE9FF]', 'bg-[#FFF8E6]', 'bg-[#FFE9EC]'];

const DAY_TEXT_COLORS = ['text-emerald-600', 'text-purple-600', 'text-amber-600', 'text-rose-600'];
    ...
    <div className="flex flex-col h-full min-h-0">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          <Button variant="outline" size="sm" onClick={onTodayClick} className="rounded-xl gap-2">
