        ...
        <PopoverTrigger asChild>
          ...
          >
            {selectedSubSchool ? (
              <>
                <SchoolAvatar
                  name={selectedSubSchool.name}
                  logoUrl={selectedSubSchool.logo}
                  className="mr-2"
                />
...
function CreateSchoolForm({ onSuccess }: { onSuccess: () => void }) {
  ...
  return (
    <div className="p-6">
      <h2 className="text-lg font-semibold mb-4 text-zinc-900">{t('school.createSchool')}</h2>
