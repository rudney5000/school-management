        ...
        <div className="space-y-4">
          <div>
            <Label className="text-sm text-gray-500">
              {t('dashboard.reports.detail.category')}
            </Label>
          ...
          <div>
            <Label className="text-sm text-gray-500">
              {t('dashboard.reports.detail.description')}
            </Label>
          ...
          {report.involvedPersonName && (
            <div>
              <Label className="text-sm text-gray-500">
                {t('dashboard.reports.detail.involvedPerson')}
              </Label>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label className="text-sm text-gray-500">
                {t('dashboard.reports.detail.createdAt')}
              </Label>
              <p className="text-sm">{new Date(report.createdAt).toLocaleString('fr-FR')}</p>
            </div>
            <div>
              <Label className="text-sm text-gray-500">
                {t('dashboard.reports.detail.isAnonymous')}
              </Label>
              <p className="text-sm">
                {report.isAnonymous
                  ? t('dashboard.reports.detail.yes')
                  : t('dashboard.reports.detail.no')}
              </p>
            </div>
          </div>
          ...
          {report.resolutionNote && (
            <div>
              <Label className="text-sm text-gray-500">
                {t('dashboard.reports.detail.resolutionNote')}
              </Label>
          ...
          {report.resolvedAt && (
            <div>
              <Label className="text-sm text-gray-500">
                {t('dashboard.reports.detail.resolvedAt')}
              </Label>
          ...
          <div className="border-t pt-4">
            <Label className="text-sm text-gray-500 mb-2 block">
              {t('dashboard.reports.detail.updateStatus')}
            </Label>
            <div className="space-y-2">
              ...
              >
                {updateStatusMutation.isPending
                  ? t('dashboard.reports.detail.updating')
                  : t('dashboard.reports.detail.update')}
              </Button>
            </div>
          </div>
        </div>
