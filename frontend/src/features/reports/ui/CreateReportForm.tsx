                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-2">
                        ...
                        >
                            ...
                            <SelectContent>
                                <SelectItem value="harassment">{t('dashboard.reports.category.harassment')}</SelectItem>
                                ...
                                <SelectItem value="teacher_absence">{t('dashboard.reports.category.teacher_absence')}</SelectItem>
                    ...
                    {formData.category === 'other' && (
                        <div className="space-y-2">
                            <Label htmlFor="otherCategoryLabel">{t('dashboard.reports.form.otherCategory')}</Label>
                            <Input
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="involvedPersonRole">{t('dashboard.reports.form.involvedPersonRole')}</Label>
                        <Select
                            value={formData.involvedPersonRole || ''}
                            onValueChange={(value) => setFormData({ ...formData, involvedPersonRole: value as any })}
                        >
                            <SelectTrigger>
                    ...
                    <div className="flex justify-end space-x-2">
                        ...
                        <Button type="submit" disabled={mutation.isPending}>
                            {mutation.isPending ? t('dashboard.reports.form.submitting') : t('dashboard.reports.form.submit')}
                        </Button>
                    </div>
                </form>
            </DialogContent>
