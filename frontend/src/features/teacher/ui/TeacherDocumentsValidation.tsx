...
export function TeacherDocumentsValidation({
  ...
  const handlePreviewPdf = () => {
    const params: TeacherContractPdfParams = {
      subSchoolId,
      teacherId,
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <Button
            ...
            title={
              !isSigned ? t('dashboard.teachers.documents.validation.downloadDisabled') : undefined
            }
          >
        ...
        {allRequiredValidated && (
          <Badge variant="success">{t('dashboard.teachers.documents.validation.complete')}</Badge>
        )}
      </div>
