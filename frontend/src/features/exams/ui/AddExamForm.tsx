...
import { createExamSchema, useCreateExam, ExamType, type CreateExamDto } from '@entities/exams';
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                  ...
                  <div className="space-y-1 leading-none">
                    <FormLabel className="cursor-pointer">Examen en ligne (avec live)</FormLabel>
                  </div>
                </FormItem>
              )}
            />
