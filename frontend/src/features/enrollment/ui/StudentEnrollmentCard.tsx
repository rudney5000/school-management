...
import { useEnrollmentSignatureStatus } from '@entities/document-signature';
    ...
    <div className="rounded-2xl bg-white border border-zinc-100/80 shadow-[0_1px_3px_rgba(0,0,0,0.04),0_4px_12px_rgba(23,85,236,0.04)] p-4">
      <div className="flex items-center justify-between mb-3">
        ...
        {enrollment ? (
          ...
          <Badge variant="outline">{t('dashboard.enrollment.students.none')}</Badge>
        )}
      </div>
      ...
      {!readOnly &&
        (enrollment ? (
          ...
          <CreateEnrollmentForm studentId={studentId} subSchoolId={subSchoolId} />
        ))}
