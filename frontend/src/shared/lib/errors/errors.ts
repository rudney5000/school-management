export const errors = {
    login: {
        ...
        invalidCredentials: {
            ...
            ln: "Email to mot de passe ezali malamu te",
        },
    },
    refresh: {
        failed: {
            en: "Refresh token failed",
            fr: "Échec du rafraîchissement du token",
            ru: "Ошибка обновления токена",
            ln: "Kobongisa token elongi te",
        },
    },
    parsing: {
        invalidResponse: {
            en: "Invalid server response",
            fr: "Réponse serveur invalide",
            ru: "Неверный ответ сервера",
            ln: "Eyano ya serveur ezali malamu te",
        },
    },
    http: {
        401: {
            ...
            fr: "Non autorisé",
            ru: "Неавторизован",
            ln: "Ozali na ndingisa te",
        },
        500: {
            en: "Server error",
            fr: "Erreur serveur",
            ru: "Ошибка сервера",
            ln: "Libunga ya serveur",
        },
    },
    network: {
        failed: {
